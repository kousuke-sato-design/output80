...
<div class="space-y-8">
	...
	<div class="text-center">
		<a
			href="/excel-preview"
			class="inline-flex items-center space-x-2 px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors shadow-md"
		>
			...
			<span>Excelファイルをプレビュー</span>
		</a>
		<p class="text-sm text-gray-500 mt-2">
			80sample.xlsなどのエクセルファイルを表示できます
		</p>
	</div>
